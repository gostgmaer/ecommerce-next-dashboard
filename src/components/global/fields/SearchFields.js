    ...
    <div className="flex flex-wrap items-center gap-4 w-full">
      <div className="rizzui-input-root flex flex-col">
        <label className="block">
          <span className="rizzui-input-container flex items-center peer w-full transition duration-200 px-3.5 py-2 text-sm leading-[40px] rounded-md bg-transparent [&amp;.is-focus]:ring-[0.6px] border border-gray-300 [&amp;_input::placeholder]:text-gray-500 hover:border-gray-900 [&amp;.is-focus]:border-gray-900 [&amp;.is-focus]:ring-gray-900 h-9">

import RegisterForm from "@/components/pages/auth/forms/register";
...
const Register = () => {
  return (
    <div className="min-h-screen bg-white justify-between gap-x-8 px-4 py-8 pt-10 md:pt-12 lg:flex lg:p-6 xl:gap-x-10 xl:p-7 2xl:p-10 2xl:pt-10 [&amp;>div]:min-h-[calc(100vh-80px)]">
      <div class="relative flex w-full items-center justify-center lg:w-5/12 2xl:justify-end 2xl:pe-24">
        <div class=" w-full max-w-sm md:max-w-md lg:py-7 lg:ps-3 lg:pt-16 2xl:w-[630px] 2xl:max-w-none 2xl:ps-20 2xl:pt-7">
          <a
            class="absolute -top-4 start-0 hidden p-3 text-gray-500 hover:text-gray-700 lg:flex lg:items-center 2xl:-top-7 2xl:ps-20 "
            href="/"
          >
            <svg
              stroke="currentColor"
            ...
            <b class="ms-1 font-medium">Back to home</b>
          </a>
          <div className="mb-7 px-6 pt-3 text-center md:pt-0 text-black lg:px-0 lg:text-start xl:mb-8 2xl:mb-10">
            ...
            <h2 class="rizzui-title-h2 mb-5 text-[26px] leading-snug md:text-3xl md:!leading-normal lg:mb-7 lg:pe-16 lg:text-[28px] xl:text-3xl 2xl:pe-8 2xl:text-4xl">
              ...
              <span class="relative inline-block">
                ...
                <svg
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  class="absolute -bottom-2 start-0 h-2.5 w-28 text-blue xl:-bottom-1.5 xl:w-36"
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
          ...
          <div class="grid grid-cols-1 gap-4 pb-5 md:grid-cols-2 md:pb-6 xl:gap-5 xl:pb-7">
            <button
            ...
            >
              ...
              <span className="truncate">signup With Apple</span>
            </button>
            <button
...
c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
              ...
              <span className="truncate text-black">signup With Google</span>
            </button>
          </div>
          <div class="before:content-[' '] relative  mt-0.5 flex items-center  before:absolute before:left-0 before:top-1/2 before:h-px before:w-full before:bg-gray-100 mb-5 2xl:mb-7 justify-center">
            <span class="relative z-10 inline-block bg-white text-sm font-medium text-gray-500 dark:bg-gray-50 2xl:text-base p-2.5">
              OR
            </span>
          </div>
         <RegisterForm/>
          <p class="mt-6 text-center leading-loose text-gray-500 lg:mt-8 lg:text-start">
            Don’t have an account?{" "}
            <Link
              class="font-semibold text-gray-700 transition-colors hover:text-blue"
              href="/auth/login"
            >
              Sign In
            </Link>
